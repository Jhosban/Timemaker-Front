        ...
        <div className="h-screen md:flex">
            ...
            <div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
                <form className="bg-white">
                    <h1 className="text-gray-800 font-bold text-2xl mb-1 text-center">Inicia sesión</h1>
                    <p className="text-sm font-normal text-gray-600 mb-4">Bienvenido otra vez!!</p>
                    <div className="flex items-center border-2 border-gray-300 py-2 px-3 rounded-2xl mb-4">
                        ...
                        <input onChange={(e) => setEmail(e.target.value)} className="pl-2 outline-none border-none w-full" type="text" placeholder="Correo" />
                    </div>
                    <div className="flex items-center border-2 border-gray-300 py-2 px-3 rounded-2xl">
                        ...
                        <input onChange={(e) => setPassword(e.target.value)} className="pl-2 outline-none border-none w-full" type="password" placeholder="Contraseña" />
                    </div>
                    <button onClick={handleClickLogin} type="submit" className="block w-full bg-blue-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Inicia sesión</button>
                </form>
            </div>
        </div>
    )
